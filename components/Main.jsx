...
const Main = () => {
    ...
    return ( 
        <div className="p-8 bg-white border border-gray-200 rounded-2xl shadow-2xl lg:min-w-lg min-w-md flex flex-col items-center">    
          ...
          <h1 className="text-2xl font-bold text-gray-900 text-center mb-4 mt-4">Search for Github Profiles</h1>
          <Form action="#" className="flex flex-col w-full" onSubmit={handleSubmit}>
            <div className="input-container">
               <label htmlFor="username" className="block mb-2 text-gray-600">Github Username</label>
                <input 
                    type="text" 
                    name="username" 
                    id="username" 
                    ...
                    className="p-4 ring-2 ring-gray-300 outline-hidden rounded-lg w-full text-gray-900 placeholder-gray-300 focus:placeholder-gray-900 focus:ring-gray-900 duration-300"
                /> 
          ...
          {Object.keys(searchResult).length > 0 && <SearchResults user={searchResult} />}
          {notFound ? <NotFound /> : ''}
